...
public class FormatT {
    ...
    public void OffsetDateTimeComparation(){
        ...
        Assert.assertTrue("OffsetDateTime can not compare with equal",time1.equals(time2));

        Assert.assertFalse("OffsetDateTime should compare with isEqual",time1.isEqual(time2));
